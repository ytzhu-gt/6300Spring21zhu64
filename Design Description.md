...
- To realize this requirement, I added a ¡®currentCashier¡¯ to the register class to track the signed-in cashier, 
and a float ¡®till¡¯ to represent the money in the till. These values are entered by the startup() method, 
after prompts are handled within the GUI.
